...
//                console.log("          ");
//                console.log("This is base string################################"+base_string);
//                console.log("          ");
//                console.log('SEEEEEEEEEEEEEEEAAAAAAAAAAAAAAAAAAAAAAAAAAAA.......'+CryptoJS.HmacSHA1(base_string, key).toString(CryptoJS.enc.Base64));
...
OAuth.prototype.authorize = function(request, token) {
    ...
    //console.log("printing inside API######TOKEN PUBLIC"+token.public);
    //console.log("printing inside API######TOKEN SECRET"+token.secret);
...
//    console.log(" ");
//    console.log("This is data_str##############################"+data_str);
//    console.log(" ");
